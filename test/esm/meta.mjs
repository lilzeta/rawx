...
import { some_colors, Server } from "rawx";
// import { setTimeout as wait } from "timers/promises";
// import { existsSync } from "fs";

const test = path.resolve("test");
const subserver_conf = path.join(test, "esm", "simple.mjs");
        ...
        new Server({
            ...
            procs: [
                ...
                },
                {
                    ...
                    run_if_file_dne: "./dist/cjs/index.cjs",
                    goto_on_file_exists: 2,
                    chain_exit: "success",
                },
                // {
                //     type: "exec",
                //     command: "npm run post_build",
                ...
                //     run_if_file_dne: "./dist/dist/rawx-0.3.0.tgz",
                //     goto_on_file_exists: 4,
                //     chain_exit: "success",
                // },
                // {
                //     type: "exec",
                ...
                {
                    type: "exec",
                    command: "node ./test/esm/simple.mjs",
                    // concurrent: {
                    //     type: "spawn",
                    //     command: "start",
                    //     args: [
            ...
            // If /test/esm/simple.mjs changes just restart, if src rebuild first
            trigger_indices: [5, 0],
            watch: {
