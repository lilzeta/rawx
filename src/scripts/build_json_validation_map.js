...
const Server = require("../../dist/node-enabled/server.js");
const Watch = require("../../dist/node-enabled/watch");
...
//     // pulse: 400,
// };
const rules_location = resolve(".", "src", "util", "validation", "rules");
...
const get_dict = (a_class, rules) => {
    let dict = {
        _notice: "autogenerated file see ./src/scripts/build_json_validator.js",
    };
...
// TODO switch to copy to dist?
const dist_val_dir = resolve("dist", "util", "validation", "schema");
if (!existsSync(dist_val_dir)) mkdirSync(dist_val_dir);
const src_val_dir = resolve("src", "util", "validation", "schema");
